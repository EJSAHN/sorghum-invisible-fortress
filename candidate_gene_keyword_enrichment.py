# =============================================================================
# Candidate-gene GO and keyword enrichment analysis
# Summarizes functional annotations for candidate genes identified by GWAS.
# Matches genes to Gene Ontology (GO) terms and predefined keyword groups.
# Usage: run inside a directory that contains the pipeline outputs, or provide paths with CLI arguments.
...
def main():
    ...
    ap.add_argument("--out", default="outputs", help="Directory containing pipeline outputs")
    ...
    if os.path.exists(cand_csv):
        ...
        raise FileNotFoundError("Please provide CandidateGenes_Annotated.csv in outputs/.")
